...
def display_all_pg_details(request,area,rent):
    ...
    if rent!=['0'] and area!='area':
        PI=PGInformation.objects.filter((Q(area=area)) & ((Q(fees2_ange=(rent[0],rent[1]))) | (Q(fees3_range=(rent[0],rent[1]))) | (Q(fees4_range=(rent[0],rent[1]))) | (Q(fees_range=(rent[0],rent[1]))) ))
