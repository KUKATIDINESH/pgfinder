    ...
    class Meta:
        ...
        widgets={
            'two_sharing':forms.TextInput(attrs={'class':'two_sharing'}),
             ...
             'vaccancy2':forms.IntegerField(attrs={'class':'vaccancy2','disabled':'di'}),

            'three_sharing':forms.TextInput(attrs={'class':'three_sharing'}),
            'vaccancy3':forms.IntegerField(attrs={'class':'vaccancy3'}),


            'four_sharing':forms.TextInput(attrs={'class':'four_sharing'}),
            'vaccancy4':forms.IntegerField(attrs={'class':'vaccancy4'}),


            'other_sharing':forms.TextInput(attrs={'class':'other_sharing'}),
            'vaccancy':forms.IntegerField(attrs={'class':'vaccancy'}),
