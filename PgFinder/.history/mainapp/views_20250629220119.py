...
def display_all_pg_details(request,area,rent):
    ...
    elif area!='area':PI=PGInformation.objects.filter(  (
       Q(fees2_eange=(rent[0],rent[1]))) | (Q(fees3_range=(rent[0],rent[1]))) | (Q(fees4_range=(rent[0],rent[1]))) | (Q(fees_range=(rent[0],rent[1])))  )  
