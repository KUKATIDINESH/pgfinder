...
def display_all_pg_details(request,area,rent):
    ...
    if rent!=['0'] and area!='area':
        PI=PGInformation.objects.filter((Q(area=area)) & ((Q(fees2__ange=(rent[0],rent[1]))) | (Q(fees3__range=(rent[0],rent[1]))) | (Q(fees4__range=(rent[0],rent[1]))) | (Q(fees__range=(rent[0],rent[1]))) ))
