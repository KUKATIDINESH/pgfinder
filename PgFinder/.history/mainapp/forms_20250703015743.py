    ...
    class Meta:
        ...
        widgets={
            'two_sharing':forms.TextInput(attrs={'class':'two_sharing'}),
             ...
             'vaccancy2':forms.(attrs={'class':'vaccancy2','disabled':'disabled'}),
             'fees2':forms.(attrs={'class':'fees1','disabled':'disabled'}),
             

            'three_sharing':forms.TextInput(attrs={'class':'three_sharing'}),
            'vaccancy3':forms.(attrs={'class':'vaccancy3','disabled':'disabled'}),
            'fees3':forms.(attrs={'class':'fees1','disabled':'disabled'}),


            'four_sharing':forms.TextInput(attrs={'class':'four_sharing'}),
            'vaccancy4':forms.(attrs={'class':'vaccancy4','disabled':'disabled'}),
            'fees4':forms.(attrs={'class':'fees1','disabled':'disabled'}),


            'other_sharing':forms.TextInput(attrs={'class':'other_sharing'}),
            'vaccancy':forms.(attrs={'class':'vaccancy','disabled':'disabled'}),
            'fees':forms.(attrs={'class':'fees1','disabled':'disabled'}),
