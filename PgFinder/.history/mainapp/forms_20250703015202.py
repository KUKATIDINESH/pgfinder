    ...
    class Meta:
        ...
        widgets={
            'two_sharing':forms.TextInput(attrs={'class':'two_sharing'}),
             ...
             'fees1':forms.IntegerField(attrs={'class':'fees1','disabled':'disabled'}),
            ...
            'fees3':forms.IntegerField(attrs={'class':'fees1','disabled':'disabled'}),
            ...
            'fees4':forms.IntegerField(attrs={'class':'fees1','disabled':'disabled'}),
            ...
            'fees':forms.IntegerField(attrs={'class':'fees1','disabled':'disabled'}),
